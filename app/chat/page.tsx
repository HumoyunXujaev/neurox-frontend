...
export default function ServiceBotChatPage() {
                ...
                <AnimatePresence>
                  {messages.map((message, index) => (
                    <motion.div
                      ...
                      className={`flex ${
                        message.is_sent_by_bot ? 'justify-start' : 'justify-end'
                      }`}
                    >
                      <div
                        className={`flex ${
                        ...
                        >
                          ...
                          <div
                            className={`absolute top-0 ${
                              message.is_sent_by_bot ? '-right-20' : '-left-20'
                          ...
                          {selectedBot && (
                            <div className='flex justify-between items-center'>
                              ...
                              <Badge variant='secondary' className='text-xs'>
                                {calculateMessageCost(selectedBot.llm_model)} BC
                              </Badge>
                            </div>
                          )}
                        </div>
